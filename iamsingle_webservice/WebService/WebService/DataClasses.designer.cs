...
namespace WebService
{
    ...
    partial void DeleteFriend(Friend instance);
		...
		public DataClassesDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["LocationServiceConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OndescChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend", Storage="_Friends", ThisKey="userid", OtherKey="uid")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend1", Storage="_Friends1", ThisKey="userid", OtherKey="fuid")]
    ...
    partial void OnfuidChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_fuid", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int fuid
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend", Storage="_User", ThisKey="uid", OtherKey="userid", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend1", Storage="_User1", ThisKey="fuid", OtherKey="userid", IsForeignKey=true)]
		public User User1
		{
			get
			{
			...
			set
			{
							...
							|| (this._User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._fuid = value.userid;
					}
					else
					{
						this._fuid = default(int);
					}
